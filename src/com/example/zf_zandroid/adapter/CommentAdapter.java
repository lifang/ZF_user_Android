	...
	public View getView(final int position, View convertView, ViewGroup parent) {
 	 ...
 	 convertView = inflater.inflate(R.layout.comment_item, null);
 		...
 		holder = (ViewHolder)convertView.getTag();
 	 	...
 	 	list.get(position).setScore(holder.rb.getRating()*10+"");
 	 	list.get(position).setContent(holder.item_et.getText().toString());
  		 ...
  		 holder.rb.setOnRatingBarChangeListener(new OnRatingBarChangeListener() {
			...
			public void onRatingChanged(RatingBar arg0, float arg1, boolean arg2) {
				...
				System.out.println(arg0.getTag()+"--`onRatingChanged`--"+arg1);
				int index =Integer.parseInt( arg0.getTag().toString());
				list.get(index).setScore(arg1*10+"");
  		...
  		holder.item_et.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence arg0, int arg1, int arg2, int arg3) {
				// TODO Auto-generated method stub
				System.out.println(position+"<--CharSequence"+arg0.toString());
				list.get(position).setContent(arg0.toString()+"--CharSequence-");
			}
