        ...
        API.getAfterSaleRecordDetail(this, mRecordType, mRecordId, new HttpCallback<AfterSaleDetail>(this) {
            ...
            public void onSuccess(AfterSaleDetail data) {
                ...
                if (mRecordType == AfterSaleListActivity.RECORD_LEASE) {
                    ...
                    terminalPairs.put(terminalKeys[8], "");
                    terminalPairs.put(terminalKeys[9], "");
                    terminalPairs.put(terminalKeys[10], "");
                }
                ...
                switch (mRecordType) {
                    ...
                    case AfterSaleListActivity.RECORD_CANCEL:
                        ...
                        AfterSaleDetailCancel cancelDetail = (AfterSaleDetailCancel) data;
                        LinkedHashMap<String, String> cancelMaterialPairs = new LinkedHashMap<String, String>();
                        renderCategoryTemplate(R.string.after_sale_cancel_material_title, cancelMaterialPairs);
                        break;
                    case AfterSaleListActivity.RECORD_CHANGE:
                        ...
                        LinkedHashMap<String, String> changeMaterialPairs = new LinkedHashMap<String, String>();
                        renderCategoryTemplate(R.string.after_sale_change_material_title, changeMaterialPairs);
                        break;
                    case AfterSaleListActivity.RECORD_UPDATE:
                        ...
                        AfterSaleDetailUpdate updateDetail = (AfterSaleDetailUpdate) data;
                        LinkedHashMap<String, String> updateMaterialPairs = new LinkedHashMap<String, String>();
                        renderCategoryTemplate(R.string.after_sale_update_material_title, updateMaterialPairs);
                        break;
                    case AfterSaleListActivity.RECORD_LEASE:
                        ...
                        leasePairs.put(leaseKeys[1], "");
                        leasePairs.put(leaseKeys[2], "");

                        // render lease material category
                        LinkedHashMap<String, String> leaseMaterialPairs = new LinkedHashMap<String, String>();
                        renderCategoryTemplate(R.string.after_sale_lease_material_title, leaseMaterialPairs);
                        break;
                }
