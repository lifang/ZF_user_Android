...
public class API {
	...
	public static final String GETINFO = Config.PATHS + "customers/getOne/%d";
	...
	// termianl bank
	public static final String TERMINAL_BANK = Config.PATHS
			+ "terminal/ChooseBank";
	...
	public static final String TERMINAL_UPLOAD_IMAGE = Config.PATHS
			+ "terminal/upload/tempImage/";
	public static final String MERCHANT_UPLOAD_IMAGE = Config.PATHS
			+ "index/upload";
	...
	public static final String REG_PHONECODE = Config.PATHS
			+ "user/sendPhoneVerificationCodeReg";
	public static final String ZHUCHE = Config.PATHS + "user/userRegistration";
	public static final String GETPHONEPASS = Config.PATHS
			+ "user/sendPhoneVerificationCodeFind";
	public static final String order_cart = Config.PATHS + "order/cart";
	...
	public static void getAfterSaleRecordList(Context context, int recordType,
			int customId, int page, int rows, HttpCallback callback) {
		String url;
		switch (recordType) {
		case MAINTAIN:
	...
	public static void synchronous(Context context, int terminalId,
			HttpCallback callback) {
		Map<String, Object> params = new HashMap<String, Object>();
	...
	public static void EditAdres(Context context, String cityId,
			String receiver, String moblephone, String zipCode, String address,
			int isDefault, int customerId, HttpCallback callback) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cityId", cityId);
	...
	public static void ChangePass(Context context, int id, String passwordOld,
			String passsword, HttpCallback callback) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("id", id);
	...
	public static void ChangeMyInfo(Context context, int id, String name,
		...
		new HttpRequest(context, callback).post(Config.URL_CUSTOMERS_UPDATE,
				params);
	}
	...
	public static void getinfo(Context context, int id, HttpCallback callback) {
		new HttpRequest(context, callback).post(String.format(GETINFO, id));
	}

	public static void CARTFIRM(Context context, int customerId, int[] inn,
			int addressId, String comment, int is_need_invoice,
	...
	public static void NewMerchant(Context context, String title,
	...
	public static void postList(Context context, int city_id, int orderType,
			int[] brands_id, int[] category, int[] pay_channel_id,
			int[] pay_card_id, int[] trade_type_id, int[] sale_slip_id,
			int[] tDate, int has_purchase, double minPrice, double maxPrice,
			String keys, int page, int rows,
		...
		try {
			...
			if (pay_channel_id != null)
				params.put("pay_channel_id",
						new JSONArray(gson.toJson(pay_channel_id)));
			if (pay_card_id != null)
				params.put("pay_card_id",
						new JSONArray(gson.toJson(pay_card_id)));
			if (trade_type_id != null)
				params.put("trade_type_id",
						new JSONArray(gson.toJson(trade_type_id)));
			if (sale_slip_id != null)
				params.put("sale_slip_id",
						new JSONArray(gson.toJson(sale_slip_id)));
			if (tDate != null)
	...
	public static void editMerchant(Context context,
			MerchantEntity merchantEntity, HttpCallback callback) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("title", merchantEntity.getTitle() == null ? ""
				: merchantEntity.getTitle());
		params.put("legalPersonName",
				merchantEntity.getLegalPersonName() == null ? ""
						: merchantEntity.getLegalPersonName());
		params.put("legalPersonCardId",
				merchantEntity.getLegalPersonCardId() == null ? ""
						: merchantEntity.getLegalPersonCardId());
		params.put("businessLicenseNo",
				merchantEntity.getBusinessLicenseNo() == null ? ""
						: merchantEntity.getBusinessLicenseNo());
		params.put("taxRegisteredNo",
				merchantEntity.getTaxRegisteredNo() == null ? ""
						: merchantEntity.getTaxRegisteredNo());
		params.put("organizationCodeNo",
				merchantEntity.getOrganizationCodeNo() == null ? ""
						: merchantEntity.getOrganizationCodeNo());
		params.put("cityId", merchantEntity.getCityId());
		params.put("accountBankName",
				merchantEntity.getAccountBankName() == null ? ""
						: merchantEntity.getAccountBankName());
		params.put("bankOpenAccount",
				merchantEntity.getBankOpenAccount() == null ? ""
						: merchantEntity.getBankOpenAccount());
		params.put("cardIdFrontPhotoPath",
				merchantEntity.getCardIdFrontPhotoPath() == null ? ""
						: merchantEntity.getCardIdFrontPhotoPath());
		params.put("cardIdBackPhotoPath",
				merchantEntity.getCardIdBackPhotoPath() == null ? ""
						: merchantEntity.getCardIdBackPhotoPath());
		params.put(
				"bodyPhotoPath",
				merchantEntity.getBodyPhotoPath() == null ? "" : merchantEntity
						.getBodyPhotoPath());
		params.put("licenseNoPicPath",
				merchantEntity.getLicenseNoPicPath() == null ? ""
						: merchantEntity.getLicenseNoPicPath());
		params.put(
				"taxNoPicPath",
				merchantEntity.getTaxNoPicPath() == null ? "" : merchantEntity
						.getTaxNoPicPath());
		params.put("orgCodeNoPicPath",
				merchantEntity.getOrgCodeNoPicPath() == null ? ""
						: merchantEntity.getOrgCodeNoPicPath());
		params.put("accountPicPath",
				merchantEntity.getAccountPicPath() == null ? ""
						: merchantEntity.getAccountPicPath());
		params.put("id", merchantEntity.getId());
		new HttpRequest(context, callback).post(Config.URL_MERCHANT_EDIT,
				params);
	}

	public static void createMerchant(Context context, int customerId,
			MerchantEntity merchantEntity, HttpCallback callback) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("title", merchantEntity.getTitle() == null ? ""
				: merchantEntity.getTitle());
		...
		params.put("accountPicPath",
				merchantEntity.getAccountPicPath() == null ? ""
						: merchantEntity.getAccountPicPath());
		params.put("customerId", customerId);
		new HttpRequest(context, callback).post(Config.URL_MERCHANT_CREATE,
				params);
	}
	 ...
	 */
	// 我的订单--订单列表
	public static void getMyOrderAll(Context context, int customerId, String p,
	...
	// 我的订单--取消订单
	public static void cancelMyOrder(Context context, int id,
			HttpCallback callback) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("id", id);
		new HttpRequest(context, callback).post(Config.URL_CANCEL_MYORDER,
				params);
	}
	...
	public static void getMyOrderById(Context context, int id,
		...
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("id", id);
		new HttpRequest(context, callback).post(Config.URL_GET_MYORDERBYID,
				params);
	}

	// 我的订单--评论订单--批量保存
	public static void batchSaveComment(Context context, int id,
			JSONArray json, HttpCallback callback) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("id", id);
		params.put("json", json);
		new HttpRequest(context, callback).post(Config.URL_BATCH_SAVECOMMENT,
				params);
	}

	// 我的信息--我的积分列表
	public static void getIntegralList(Context context, int customerId,
			int page, int rows, HttpCallback callback) {
		String url = MessageFormat.format(Config.URL_GET_INTEGRALLIST,
				customerId + "", page, rows);
		new HttpRequest(context, callback).post(url);
	}

	// 我的信息--我的积分总计
	public static void getIntegralTotal(Context context, int customerId,
			HttpCallback callback) {
		String url = MessageFormat.format(Config.URL_GET_INTEGRALTOTAL,
				customerId + "");
		new HttpRequest(context, callback).post(url);
	}

	// 我的信息--提交积分兑换
	public static void insertIntegralConvert(Context context, int customerId,
			String name, String phone, String price, HttpCallback callback) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("customerId", customerId);
		params.put("name", name);
		params.put("phone", phone);
		params.put("price", price);
		new HttpRequest(context, callback).post(
				Config.URL_INSERT_INTEGRALCONVERT, params);
	}

	// 我的信息--地址列表
	public static void getAddressList(Context context, int customerId,
			HttpCallback callback) {
	...
	// 我的信息--删除地址
	public static void deleteAddress(Context context, JSONArray ids,
			HttpCallback callback) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("ids", ids);
	...
	// 我的商户--商户列表
	public static void merchantGetList(Context context, int customerId,
			int page, int rows, HttpCallback callback) {
		String url = MessageFormat.format(Config.URL_MERCHANT_LIST, customerId
				+ "", page, rows);
		new HttpRequest(context, callback).post(url);
	}

	// 我的商户--删除商户
	public static void merchantDelete(Context context, JSONArray ids,
			HttpCallback callback) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("ids", ids);
		new HttpRequest(context, callback).post(Config.URL_MERCHANT_DELETE,
				params);
	}

	// 我的消息---消息列表
	public static void receiverGetAll(Context context, int customer_id,
			int page, int rows, HttpCallback callback) {
		Map<String, Object> params = new HashMap<String, Object>();
	...
	// 我的消息---批量已读
	public static void batchRead(Context context, int customer_id,
			JSONArray ids, HttpCallback callback) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("customer_id", customer_id);
		params.put("ids", ids);
	...
	// 我的消息---批量删除
	public static void batchDelete(Context context, int customer_id,
			JSONArray ids, HttpCallback callback) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("customer_id", customer_id);
		params.put("ids", ids);
	...
	// 我的消息---消息详情
	public static void receiverGetById(Context context, int customer_id,
	...
	// 我的消息---单个删除
	public static void receiverDeleteById(Context context, int customer_id,
			int id, HttpCallback callback) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("customer_id", customer_id);
		params.put("id", id);
	...
	// 找回密码--获得手机验证码
	public static void sendPhoneCode(Context context, String codeNumber,
			HttpCallback callback) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("codeNumber", codeNumber);
		new HttpRequest(context, callback).post(Config.URL_SEND_PHONECODE,
				params);
	}

	// 购物车列表
	public static void cartList(Context context, int customerId,
			HttpCallback callback) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("customerId", customerId);
